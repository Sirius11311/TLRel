...
class CRF(nn.Module):
    ...
    def _viterbi_decode(self, feats, mask):
        ...
        for idx, cur_values in seq_iter:
            ...
            cur_bp.masked_fill_(mask[idx].view(batch_size, 1).expand(batch_size, tag_size), False)
    ...
    def _viterbi_decode_nbest(self, feats, mask, nbest):
        ...
        for idx, cur_values in seq_iter:
            ...
            cur_bp.masked_fill_(mask[idx].view(batch_size, 1, 1).expand(batch_size, tag_size, nbest), False)
